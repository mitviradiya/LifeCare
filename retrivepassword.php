...
<body>
   <?php
$query = "select * from tbllogin where username='".$_REQUEST["txtusername"]."' and securityquestion='".$_REQUEST["txtquestion"]."' and securityanswer='".$_REQUEST["txtanswer"]."'";
...
if($no>0)
{
	...
	$r= "Your Password Is : <u><b style='color:#0798BC'>".$row[2]."</b></u>";
}
else
{
	$r="Enter Correct Security Details";
}
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-sm-8">
		...
		<form class="callus" method="post" action="forgotpassword.php"  id="contact_form">
		...
		<input type="Submit" name="back" value="Back" id="btn_contact_submit"/>
                 ...
                 <div class="btn-submit button3">
		<input type="button" name="loginbtn" id="btn_contact_submit"/><a href="login.php">Go To Login</a></input>
		</div>
