...
<div class="topbar">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <p class="pull-left hidden-xs">LifeCare - Expect the Best in Town</p>
        <p class="pull-right"><i class="fa fa-ambulance"></i>Emergency Line (+091) 079-654-3210</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-7 col-sm-6">
        <p class="half_space">Get Instant Responses to Queries, Book Free Text & Online Appointment.</p>
        <p class="half_space">That also the leap into electronic typesetting, remaining essentially unchanged.</p>
        <p class="half_space">It was popularised in the LifeCare with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
