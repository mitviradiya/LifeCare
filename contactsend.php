...
<?php
				...
				{
			$query="insert into tblcontactmsg(name,email,message) values('".$_REQUEST["f_name"]."','".$_REQUEST["email"]."','".$_REQUEST["message"]."')";
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-sm-8">
		...
		<form class="callus" method="post" action="contact.php"  id="contact_form">
        <h2> Message Succesfully Sended</h2><br><br>
