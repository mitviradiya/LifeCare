  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
         ...
         <div class="page_link"><a href="index.html">Home</a><span><i class="fa fa-long-arrow-right"></i>Login Form</span></div>
      </div>
    </div>
  </div>
</div>  
...
{
	$i="*Invalid User Name or Password";
}
else
{
	$i="";
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="col-md-7 col-sm-8">
          ...
          <div class="row">
            <form class="callus" method="post" action="loginvalidate.php"  id="app_form">
              <div class="row">
				...
				<h3 style="margin-left:150px;"> User Name : </h3>
                  </div>
                </div>
               <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control" type="text" name="txtusername" id="name"  placeholder="User Name" required />
                  </div>
                </div> 
             <!-- <div class="col-md-3">
                  <div class="form-group">
			 ...
			 <!-- <input class="form-control" type="email"  name="email" id="email" placeholder="Email" required /> -->
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <input type="password" class="form-control" placeholder="Password" id="password" name="txtpassword" required />
                  </div>
                </div>
				<div class="col-md-6">
				</div>
				<div class="col-md-6">
				<div style="color:#FF0000; font-size=10px; margin-bottom:10px; font-family:'ralewaylight'; "><?php echo $i; ?></div></div>
				</div>
				<div class="col-md-5">
				</div>
				<div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="submit" id="btn_app_submit" value="Login" />
                    </div>
                  </div>
                </div><div class="col-md-4">
                  <div class="form-group">
                     <div class="btn-submit button3">
                    <input type="button" id="btn_app_submit" Action="forgotpassword.php" ><a href="forgotpassword.php">Forgot Password</a></input>
                    </div>
                  </div>
                </div>
              </div>
