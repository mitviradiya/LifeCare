...
<?php
$query="select * from tblappoint where userid=".$_SESSION["userid"]." AND prescription<>''  order by appointmentid desc";
           ...
           <a class="navbar-brand" href="index.html"><img src="images/logo.png" alt="logo" class="img-responsive"></a> 
            ...
            <div id="fixed-collapse-navbar" class="navbar-collapse collapse navbar-right">
			  ...
			  <li><a href="#"><b>Welcome <?php echo $_SESSION["username"]; ?> </b></a></li>
				...
				<li class="dropdown">
                  <a data-toggle="dropdown" href="#" class="dropdown-toggle active">Appointment</a>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
         ...
         <div class="page_link"><a href="index.html">Home</a><span><i class="fa fa-long-arrow-right"></i>Appointment<i class="fa fa-long-arrow-right"></i>Prescription</span></div>
      </div>
    </div>
  </div>
</div>  
 ...
 <?php
				  ...
				  { 
                    echo "<tr>";
						   ...
						   echo "<td class='col-md-2'>".$row[6]."</td>";
