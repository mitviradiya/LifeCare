  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
         ...
         <div class="page_link"><a href="index.html">Home</a><span><i class="fa fa-long-arrow-right"></i>Blog</span></div>
      </div>
    </div>
  </div>
</div>  
    ...
    <div class="row">
      <div class="col-md-8 col-sm-7">
        <div class="blog_item padding-bottom">
          ...
          <h3 class="half_space">Medical Surgery</h3>
          ...
          <li><a href="#"><i class="icon-tag2"></i>benefits, body, health</a></li>
          </ul>
        ...
        <aside class="sidebar">
          ...
          <div id="tab1" class="tab_content">
            <div class="single_comments">
              ...
              <p><a href="#">Geometric Landscapes Heartologic</a></p>
              <span>Sep 05, 2016</span>
            </div>
            <div class="clearfix"></div>
            <div class="single_comments">
              <img alt="" src="images/avator1.jpg">
              <p><a href="#">The Beauty of the Childhood</a></p>
              <span>Ayg 25, 2016</span>
            </div>
            <div class="clearfix"></div>
            <div class="single_comments no-margin">
              <img alt="" src="images/avator1.jpg">
              <p><a href="#">Diabetes Diet and Healthy food Tips</a></p>
              <span>Sep 05, 2016</span>
            </div>
            <div class="clearfix"></div>
          </div>
