...
<?php
$query="select * from tblappoint where userid=".$_SESSION["userid"]." and appointmentdate!='0000-00-00' and appointmenttime!='00:00:00' order by appointmentid desc";
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
         ...
         <div class="page_link"><a href="index.html">Home</a><span><i class="fa fa-long-arrow-right"></i>Appointment<i class="fa fa-long-arrow-right"></i>Confirm Appointment</span></div>
      </div>
    </div>
  </div>
</div>  
