...
<?php
$query="select * from tblappoint where userid=".$_SESSION["userid"]." order by appointmentid	DESC" ;
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
         ...
         <div class="page_link"><a href="index.html">Home</a><span><i class="fa fa-long-arrow-right"></i>Appointment<i class="fa fa-long-arrow-right"></i>View All Appointment</span></div>
      </div>
    </div>
  </div>
</div>  
