  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-sm-8">
        ...
        <form class="callus" method="post" action="contactsend.php"  id="contact_form">
          <div class="row">
           ...
           <div class="col-md-12">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <input class="form-control" type="text" name="f_name" id="f_name" value="<?php echo $row[1]; ?>" disabled />
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <input class="form-control" type="text" name="l_name" id="l_name"  value="<?php echo $row[2]; ?>" disabled />
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <input class="form-control" type="email" name="email" id="email"  value="<?php echo $row[7]; ?>" disabled />
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <input class="form-control" type="text" name="phone" id="phone" value="<?php echo $row[6]; ?>" disabled />
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
