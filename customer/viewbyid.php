...
<title>View By Id Appointment</title>
...
<?php
$query="select * from tblappoint where appointmentid=".$_REQUEST["aid"]." AND userid=".$_SESSION["userid"];
//$query="select * from tblappoint where userid=".$_SESSION["userid"];
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
         ...
         <div class="page_link"><a href="index.html">Home</a><span><i class="fa fa-long-arrow-right"></i>Appointment<i class="fa fa-long-arrow-right"></i>View By Id Appointment</span></div>
      </div>
    </div>
  </div>
</div>  
...
<section class="padding">
 ...
 <?php
  ...
  if($row= mysql_fetch_array($res))
	{
        echo "<table class='table tbl-clr'>";
			echo "<tr>";
			echo "<th class='col-md-2'>Appointment id</th>";
			echo "<th class='col-md-2'>Request Date</th>";
			echo "<th class='col-md-2'>Problem</th>";
			echo "<th class='col-md-2'>Appointment Date</th>";
			echo "<th class='col-md-2'>Appointment Time</th>";
			echo "</tr>";
			      ...
			      //while($row= mysql_fetch_array($res))
                    ...
                    echo "<tr>";
						   ...
						   echo "<td class='col-md-2'>".$row[3]."</td>";
                           echo "<td class='col-md-2'>".$row[2]."</td>";
						   echo "<td class='col-md-2'>".$row[4]."</td>";
						  echo "<td class='col-md-2'>".$row[5]."</td>";
	 ...
	 {
		 echo "<h2 style='color:#ff0000';> Wrong Id, Please Enter Right ID...!!! </h2> "; 
     }
