  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
         ...
         <div class="page_link"><a href="index.html">Home</a><span><i class="fa fa-long-arrow-right"></i>Login<i class="fa fa-long-arrow-right"></i>Forgot Password</span></div>
      </div>
    </div>
  </div>
</div>  
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="col-md-7 col-sm-8">
          ...
          <div class="row">
            <form class="callus" method="post" action="retrivepassword.php"  id="app_form">
              <div class="row">
				...
				<h3 style="margin-left:60px;">  User Name : </h3>
                  </div>
                </div>
               <div class="col-md-6">
                  <div class="form-group">
				...
				<div class="col-md-6">
                  <div class="form-group">
				<h3 style="margin-left:60px;"> Security Question  : </h3>
                  </div>
                </div>
               <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control" type="text" name="txtquestion" id="name"  placeholder="Security Question" required />
                  </div>
                </div> 
				 <div class="col-md-6">
                  <div class="form-group">
					<h3 style="margin-left:150px;"> Answer : </h3>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Answer" name="txtanswer" required />
                  </div>
                </div>
				<div class="col-md-6">
				</div>
               ...
               <!--   <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="submit" id="btn_app_submit" value="Submit" />
                    </div>
                  </div>
                </div>
              </div>
