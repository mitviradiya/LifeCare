...
<th class="col-md-2">Problem</th>
 ...
 <?php
				...
				//	{
                    echo "<tr class='tbl'>";
                           echo "<td class='col-md-2'><a href='reqappointmentsubmit.php?&uid=".$row[1]."&appid=".$row[0]."'>".$row[0]."</td>";
						   echo "<td class='col-md-2'><a href='reqappointmentsubmit.php?&uid=".$row[1]."&appid=".$row[0]."'>".$row[8]."</td>";
						   echo "<td class='col-md-2'><a href='reqappointmentsubmit.php?&uid=".$row[1]."&appid=".$row[0]."'>".$row[3]."</td>";
                           echo "<td class='col-md-2'><a href='reqappointmentsubmit.php?&uid=".$row[1]."&appid=".$row[0]."'>".$row[2]."</td>";
