...
<form class="callus" method="post" action="prescriptionconfirm.php"  id="app_form">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control" type="text" name="aaid" value="<?php echo $_REQUEST["apid"]; ?>" />
                  </div>
                </div>
				<div class="col-md-2">
				</div>
				<div class="col-md-4">
                  <div class="form-group">
				  <h4 style="margin-top:2px;">Prescription :</h4>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control" type="text" name="prescription" placeholder="Enter Prescription" />
                  </div>
                </div>
                <div class="col-md-4">
				</div>
