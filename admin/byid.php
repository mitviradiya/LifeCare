  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
         ...
         <div class="page_link"><a href="index.html">Home</a><span><i class="fa fa-long-arrow-right"></i>View By Id</span></div>
      </div>
    </div>
  </div>
</div>  
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="col-md-7 col-sm-8">
          ...
          <div class="row">
            <form class="callus" method="post" action="profile.php"  id="app_form">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <h4 style="margin-left:150px; margin-top:8px">Client Id :</h4>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control" type="text"  name="cid" placeholder="Enter Client Id" required />
                  </div>
                </div>
                <div class="col-md-5">
				</div>
