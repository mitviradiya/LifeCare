	  ...
	  
{
		  ...
		  $query="update tbluser set firstname='".$_REQUEST["txtfirstname"]."' , lastname='".$_REQUEST["txtlastname"]."' , address='".$_REQUEST["txtaddress"]."',city='".$_REQUEST["txtcity"]."',pincode='".$_REQUEST["txtpincode"]."',mobile='".$_REQUEST["txtmobile"]."',email='".$_REQUEST["txtemail"]."',gender='".$_REQUEST["txtgender"]."',birthdate='".$_REQUEST["txtbirthdate"]."' where userid=".$_REQUEST["cid"];
		  mysql_query($query);
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
         ...
         <div class="page_link"><a href="index.html">Home</a><span><i class="fa fa-long-arrow-right"></i>Profile<i class="fa fa-long-arrow-right"></i>Profile Modify</span></div>
      </div>
    </div>
  </div>
</div>  
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-sm-8">
        <h2 class="heading">Profile Modify</h2>
        <hr class="heading_space">
		<form class="callus" method="post" action="index.php"  id="contact_form">
        <h2> Profile Successfully Modified</h2><br><br>
