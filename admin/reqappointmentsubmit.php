...
<form class="callus" method="post" action="reqappointmentconfirm.php"  id="app_form">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control" type="text" name="aapid" value="<?php echo $_REQUEST["appid"]; ?>" required />
                  </div>
                </div>
				<div class="col-md-2">
				</div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control" type="text" placeholder="yyyy-mm-dd" name="appdate" required />
                  </div>
                </div>
				<div class="col-md-2">
				</div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control" type="text" placeholder="HH:MM" name="apptime" required />
                  </div>
                </div>
                <div class="col-md-4">
				</div>
