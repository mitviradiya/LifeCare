...
<body>
<?php
$query="select * from tbluser where userid=".$_REQUEST["cid"] ;
            ...
            <div id="fixed-collapse-navbar" class="navbar-collapse collapse navbar-right">
              <ul class="nav navbar-nav">
               <li><a href="#"><b>Welcome <?php echo $_SESSION["username"]; ?> </b></a></li>
				...
				<li class="active"><a href="byid.php">Client Profile</a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="col-md-7 col-sm-8">
          ...
          <div class="row">
            <form class="callus" method="post" id="app_form" action="modifyprofile.php?&cid=<?php echo $row[0] ?>" >
              <div class="row">
               ...
               <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control" type="text" name="txtfirstname" id="name"  value="<?php echo $row[1]; ?>" disabled />
                  </div>
                </div> 
              <div class="col-md-3">
				</div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Last Name"  value="<?php echo $row[2]; ?>" disabled />
                  </div>
                </div> 
				<div class="col-md-3">
				</div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <textarea class="form-control"  name="txtaddress" placeholder="Address" cols="5" rows="4" disabled /><?php echo $row[3]; ?></textarea>
                  </div>
                </div> 
				<div class="col-md-3">
				</div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <input type="text" class="form-control" value="<?php echo $row[4]; ?>"  name="txtcity" disabled />
                  </div>
                </div> 
				<div class="col-md-3">
				</div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                  <input type="text" class="form-control" value="<?php echo $row[5]; ?>"  name="txtpincode" disabled />
                  </div>
                </div> 
				<div class="col-md-3">
				</div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <input type="text" class="form-control" value="<?php echo $row[6]; ?>" name="txtmobile"  disabled />
                  </div>
                </div> 
				<div class="col-md-3">
				</div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <input type="email" class="form-control" value="<?php echo $row[7]; ?>" name="txtemail" disabled />
                  </div>
                </div> 
				<div class="col-md-3">
				</div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <input type="text" class="form-control" value="<?php echo $row[8]; ?>" name="txtgender" disabled  />
                  </div>
                </div> 
				<div class="col-md-3">
				</div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <input type="date" class="form-control" id="date" value="<?php echo $row[9]; ?>" disabled  name="txtbirthdate" />
                  </div>
                </div> 
				<div class="col-md-4">
				</div>       
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 footer_column">
       ...
       <form action="http://themesindustry.us13.list-manage.com/subscribe/post-json?u=4d80221ea53f3a4487ddebd93&amp;id=494727d648&amp;c=?" method="get" onSubmit="return false" class="newsletter">
          <div class="form-group">
            <input type="email" placeholder="E-mail Address" disabled name="EMAIL" id="EMAIL" class="form-control" />
          </div>
          <div class="form-group">
