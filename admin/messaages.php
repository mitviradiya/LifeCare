...
<body>
<?php
$query="select * from tblcontactmsg";
            ...
            <div id="fixed-collapse-navbar" class="navbar-collapse collapse navbar-right">
              <ul class="nav navbar-nav">
               <li><a href="#"><b>Welcome <?php echo $_SESSION["username"]; ?> </b></a></li>
                ...
                <li class="active"><a href="messaages.php">Messages</a></li>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
         ...
         <div class="page_link"><a href="index.html">Home</a><span><i class="fa fa-long-arrow-right"></i>Contact Us</span></div>
      </div>
    </div>
  </div>
</div>  
...
<table class="table tbl-clr"!important>
<tr>
<th class="col-md-4">Client Name</th>
<th class="col-md-4">Email Id</th>
<th class="col-md-4">Message</th>
<!--<th class="col-md-4">Replied Message</th> -->
</tr>

 <?php
			      while($row=mysql_fetch_array($res))
				  {   
				//	if($row[4]==0000-00-00)id="btn_app_submit" class='btn-submit button3'
				//	{
					
                    echo "<tr class='tbl'>";
					
                           echo "<td class='col-md-4'><a href='index.php?page=remessages.php&mid=".$row[0]."&email=".$row[2]."&sub=".$row[4]."'>".$row[1]."</a></td>";
						   echo "<td class='col-md-4'><a href='index.php?page=remessages.php&mid=".$row[0]."&email=".$row[2]."&sub=".$row[4]."'>".$row[2]."</a></td>";
                           echo "<td class='col-md-4'><a href='index.php?page=remessages.php&mid=".$row[0]."&email=".$row[2]."&sub=".$row[4]."'>".$row[3]."</a></td>";
						//   echo "<td class='col-md-4'><a href='index.php?page=remessages.php&mid=".$row[0]."&email=".$row[2]."&sub=".$row[4]."'>".$row[4]."</a></td>";
      ...
      <div class="col-md-4 col-sm-4 medix">
        <h2 class="heading">LifeCare</h2>
        <hr class="heading_space"> 
        <p><strong>Phone:</strong> 1.800.555.6789</p>
        <p><strong>Email:</strong> <a href="mailto:support@medix.com">support@lifecare.com</a></p>
        <p><a href="#">Web: www.lifecare.com</a></p>
        <p><strong>Address:</strong> 123 crystal mall, Ahmedabad</p>
