...
<?php
$query="select * from tblappoint inner join tbluser on tblappoint.userid=tbluser.userid where appointmentdate!=0000-00-00 order by appointmentid desc";
...
<tr>
<th class="col-md-2">Appointment id</th>
<th class="col-md-2">Client Name</th>
<th class="col-md-2">Request Date</th>
<th class="col-md-2">Problem</th>
<th class="col-md-2">Appointment Date</th>
<th class="col-md-2">Appointment Time</th>
</tr>
 ...
 <?php
				...
				//	{
                    echo "<tr class='tbl'>";
                           echo "<td class='col-md-2'><a href='modifyappointment.php?&adate=".$row[4]."&uid=".$row[1]."&apid=".$row[0]."&atime=".$row[5]."'>".$row[0]."</a></td>";
						   echo "<td class='col-md-2'><a href='modifyappointment.php?&adate=".$row[4]."&uid=".$row[1]."&apid=".$row[0]."&atime=".$row[5]."'>".$row[8]."</a></td>";
						   echo "<td class='col-md-2'><a href='modifyappointment.php?&adate=".$row[4]."&uid=".$row[1]."&apid=".$row[0]."&atime=".$row[5]."'>".$row[3]."</a></td>";
                           echo "<td class='col-md-2'><a href='modifyappointment.php?&adate=".$row[4]."&uid=".$row[1]."&apid=".$row[0]."&atime=".$row[5]."'>".$row[2]."</a></td>";
						   echo "<td class='col-md-2'><a href='modifyappointment.php?&adate=".$row[4]."&uid=".$row[1]."&apid=".$row[0]."&atime=".$row[5]."'>".$row[4]."</a></td>";
						   echo "<td class='col-md-2'><a href='modifyappointment.php?&adate=".$row[4]."&uid=".$row[1]."&apid=".$row[0]."&atime=".$row[5]."'>".$row[5]."</a></td>";
