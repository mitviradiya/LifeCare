  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
         ...
         <div class="page_link"><a href="index.html">Home</a><span><i class="fa fa-long-arrow-right"></i>Prescription</span></div>
      </div>
    </div>
  </div>
</div>  
...
<th class="col-md-2">Prescription</th>
 ...
 <?php
				  ...
				  { 
                    echo "<tr class='tbl'>";
                           echo "<td class='col-md-2'><a href='prescriptionmodify.php?&uid=".$row[1]."&apid=".$row[0]."'>".$row[0]."</a></td>";
						   echo "<td class='col-md-2'><a href='prescriptionmodify.php?&uid=".$row[1]."&apid=".$row[0]."'>".$row[3]."</a></td>";
						   echo "<td class='col-md-2'><a href='prescriptionmodify.php?&uid=".$row[1]."&apid=".$row[0]."'>".$row[4]."</a></td>";
						   echo "<td class='col-md-2'><a href='prescriptionmodify.php?&uid=".$row[1]."&apid=".$row[0]."'>".$row[5]."</a></td>";
						   echo "<td class='col-md-2'><a href='prescriptionmodify.php?&uid=".$row[1]."&apid=".$row[0]."'>".$row[2]."</a></td>";
						   echo "<td class='col-md-2'><a href='prescriptionmodify.php?&uid=".$row[1]."&apid=".$row[0]."'>".$row[6]."</a></td>";
