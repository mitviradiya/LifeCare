...
<?php
{
	$query="select * from tblappoint inner join tbluser on tblappoint.userid=tbluser.userid where appointmentdate!='0000-00-00' AND appointmentid=".$_REQUEST["aaid"];
$res=mysql_query($query);
$no = mysql_num_rows($res);
if($no>0)
			  {
			$row=mysql_fetch_array($res);
				  $r="Appointment Succesfully Modified...";
		  $query="UPDATE tblappoint SET appointmentdate='".$_REQUEST["appointdate"]."' , appointmenttime='".$_REQUEST["appointtime"]."' WHERE appointmentid=".$_REQUEST["aaid"];
		 $res= mysql_query($query);
			  }
			  else
			  {
				  $r="Appointment Not Succesfully Modified...";
			  }
}
		?>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="col-md-7 col-sm-8">
          ...
          <div class="row">
           <form class="callus" method="post" action="allocatedappointment.php"  id="contact_form">
