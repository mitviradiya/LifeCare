...
<?php
{
	$query="select * from tblappoint where appointmentid=".$_REQUEST["aaid"];
$res=mysql_query($query);	
$no = mysql_num_rows($res);
if($no>0)
			  {
			 $r="Prescription Succesfully Submit...";
		   $query="UPDATE tblappoint SET prescription='".$_REQUEST["prescription"]."' WHERE appointmentid=".$_REQUEST["aaid"];
		  mysql_query($query);
		 
			  }
			  else
			  {
				  $r="prescription Not Succesfully Submit...";
			  }
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="col-md-7 col-sm-8">
          ...
          <div class="row">
           <form class="callus" method="post" action="prescription.php"  id="contact_form">
