...
<?php
{
	$query="select * from tblappoint inner join tbluser on tblappoint.userid=tbluser.userid where appointmentdate='0000-00-00' AND appointmentid=".$_REQUEST["aapid"];
$res=mysql_query($query);	
$no = mysql_num_rows($res);
if($no>0)
			  {
			$row=mysql_fetch_array($res);
				  $r="Appointment Succesfully Confirm...";
		  $query="UPDATE tblappoint SET appointmentdate='".$_REQUEST["appdate"]."' , appointmenttime='".$_REQUEST["apptime"]."' WHERE appointmentid=".$_REQUEST["aapid"];
		 $res= mysql_query($query);
			  }
			  else
			  {
				  $r="Appointment Not Succesfully Confirm...";
			  }
		//  echo $_REQUEST["appointdate"];
		//  echo $_REQUEST["aaid"];
			//if($i==1)
		//	{
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
         ...
         <div class="page_link"><a href="index.html">Home</a><span><i class="fa fa-long-arrow-right"></i>Appointment<i class="fa fa-long-arrow-right"></i>Requested Appointment</span></div>
      </div>
    </div>
  </div>
</div>  
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="col-md-7 col-sm-8">
          ...
          <div class="row">
           <form class="callus" method="post" action="requestedappointment.php"  id="contact_form">
        <h2> <?Php echo $r; ?></h2><br><br>
		<div class="form-group">
                 <div class="btn-submit button3">
              
		<input type="Submit" name="back" value="Back" id="btn_contact_submit"/>
		</div>
		</div>
		</form>
